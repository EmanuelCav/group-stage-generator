        ...
        <ScrollView horizontal showsHorizontalScrollIndicator={false}>
            <View>
                <View style={[groupStyles.headerRow, { backgroundColor: colors.primary }]}>
                    ...
                    <Text variant="labelMedium" style={groupStyles.headerCell}>{i18n.t('group.goalsFor')}</Text>
                    <Text variant="labelMedium" style={groupStyles.headerCell}>{i18n.t('group.goalsAgainst')}</Text>
                ...
                <FlatList
                    ...
                    renderItem={({ item }) => (
                        <View style={groupStyles.row}>
                            ...
                            <View style={groupStyles.cell}>
                                <Text variant="bodyMedium">{item.positive}</Text>
                            </View>
                            <View style={groupStyles.cell}>
                                <Text variant="bodyMedium">{item.negative}</Text>
                            </View>
                            <View style={groupStyles.cell}>
